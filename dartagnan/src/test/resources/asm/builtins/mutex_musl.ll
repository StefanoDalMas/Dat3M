...
define internal i32 @vatomic32_cmpxchg_rlx(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %14 = load i32, ptr %7, align 4
  %15 = load i32, ptr %8, align 4
  %16 = cmpxchg ptr %12, i32 %14, i32 %15 monotonic monotonic, align 4
  %17 = extractvalue { i32, i1 } %16, 0
  %18 = extractvalue { i32, i1 } %16, 1
  br i1 %18, label %20, label %19
...
define internal i32 @vatomic32_get_add_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %12 = atomicrmw add ptr %9, i32 %11 monotonic, align 4
...
define internal i32 @vatomic32_get_sub_rlx(ptr noundef %0, i32 noundef %1) #0 {
  ...
  store i32 %10, ptr %6, align 4
  %11 = load i32, ptr %6, align 4
  %12 = atomicrmw sub ptr %9, i32 %11 monotonic, align 4
  store i32 %12, ptr %7, align 4
  %13 = load i32, ptr %7, align 4
  store i32 %13, ptr %5, align 4
...
define internal i32 @vatomic32_xchg_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  store i32 %10, ptr %6, align 4
  %11 = load i32, ptr %6, align 4
  %12 = atomicrmw xchg ptr %9, i32 %11 release, align 4
  store i32 %12, ptr %7, align 4
  %13 = load i32, ptr %7, align 4
  store i32 %13, ptr %5, align 4
...
define internal i32 @vatomic32_get_add_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %13 = load i32, ptr %7, align 4
  store i32 %13, ptr %5, align 4
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !29
  %14 = load i32, ptr %5, align 4
  ret i32 %14
}
