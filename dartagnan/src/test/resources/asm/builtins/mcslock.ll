...
define internal ptr @vatomicptr_xchg(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %12 = atomicrmw xchg ptr %9, i64 %11 seq_cst, align 8
...
define internal i32 @vatomic32_read_acq(ptr noundef %0) #0 {
  ...
  %4 = alloca i32, align 4
  store ptr %0, ptr %2, align 8
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !23
  ...
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !24
...
define internal ptr @vatomicptr_read_rlx(ptr noundef %0) #0 {
  ...
  %4 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !25
  %5 = load ptr, ptr %2, align 8
  %6 = getelementptr inbounds %struct.vatomicptr_s, ptr %5, i32 0, i32 0
  %7 = load atomic i64, ptr %6 monotonic, align 8
  store i64 %7, ptr %4, align 8
  %8 = load ptr, ptr %4, align 8
  store ptr %8, ptr %3, align 8
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !26
  %9 = load ptr, ptr %3, align 8
  ret ptr %9
}
...
define internal ptr @vatomicptr_cmpxchg_rel(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %10 = load ptr, ptr %5, align 8
  store ptr %10, ptr %7, align 8
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !27
  %11 = load ptr, ptr %4, align 8
  %12 = getelementptr inbounds %struct.vatomicptr_s, ptr %11, i32 0, i32 0
  %13 = load ptr, ptr %6, align 8
  store ptr %13, ptr %8, align 8
  %14 = load i64, ptr %7, align 8
  %15 = load i64, ptr %8, align 8
  %16 = cmpxchg ptr %12, i64 %14, i64 %15 release monotonic, align 8
  %17 = extractvalue { i64, i1 } %16, 0
  %18 = extractvalue { i64, i1 } %16, 1
  br i1 %18, label %20, label %19
...
20:                                               ; preds = %19, %3
  ...
  %22 = load i8, ptr %9, align 1
  %23 = trunc i8 %22 to i1
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !28
  %24 = load ptr, ptr %7, align 8
  ret ptr %24
}
...
define internal ptr @vatomicptr_read_acq(ptr noundef %0) #0 {
  ...
  %4 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !30
  %5 = load ptr, ptr %2, align 8
  %6 = getelementptr inbounds %struct.vatomicptr_s, ptr %5, i32 0, i32 0
  ...
  %8 = load ptr, ptr %4, align 8
  store ptr %8, ptr %3, align 8
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !31
  %9 = load ptr, ptr %3, align 8
  ret ptr %9
}
...
define internal void @vatomic32_write_rel(ptr noundef %0, i32 noundef %1) #0 {
  ...
  store ptr %0, ptr %3, align 8
  store i32 %1, ptr %4, align 4
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !32
  %6 = load ptr, ptr %3, align 8
  %7 = getelementptr inbounds %struct.vatomic32_s, ptr %6, i32 0, i32 0
  %8 = load i32, ptr %4, align 4
  store i32 %8, ptr %5, align 4
  %9 = load i32, ptr %5, align 4
  store atomic i32 %9, ptr %7 release, align 4
  call void asm sideeffect "", "~{memory}"() #4, !srcloc !33
  ret void
}
